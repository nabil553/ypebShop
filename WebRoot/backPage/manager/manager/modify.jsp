...
<div class="pageContent">
	<form method="post" action="backSuperLimit_SuperLimit_modify"
		...
		<input type="hidden" value="${manager.id }" name="manager.id">
			<dl>
				<dt>用户名：</dt>
				<dd>
					<input name="manager.name" type="text" size="100" alt="请输入角色名称"
						class="required" value="${manager.name }"/>
				</dd>
			</dl>
			<dl>
				<dt>选择角色：</dt>
				<select name="manager.role.id" class="required combox">
					<option value="${manager.role.id }">${manager.role.name }</option>
			...
			<dl>
				...
				<dd>
					<input name="manager.realName" type="text" size="100" alt="请输入真实名称"
						class="required" value="${manager.realName }"/>
				</dd>
			</dl>
			<dl>
				<dt>电话：</dt>
				<dd>
					<input type="text" name="manager.telephone" class="phone"
						alt="请输入您的电话" value="${manager.telephone }"/> <span class="info"></span>
				</dd>
			</dl>
			<dl>
				<dt>密码：</dt>
