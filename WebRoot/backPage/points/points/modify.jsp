...
<div class="pageContent">
	<form method="post" action="backShopping_GoodsOrder_modify" class="pageForm required-validate"
			...
			<dl>
				...
				<dd>
					<input name="order.userId" type="text" size="20" alt="请输入购买人ID"
						class="required" value="${order.userId }"/>
				</dd>
			</dl>
			<dl>
				<dt>商品ID：</dt>
				<dd>
					<input name="order.goodsId" type="text" size="20" alt="请输入商品ID"
						class="required" value="${order.goodsId }"/>
				</dd>
			</dl>
			<dl>
				<dt>单价：</dt>
				<dd>
					<input name="order.unitPrice" type="text" size="20" alt="请输入商品单价"
						class="required number" value="${order.unitPrice }"/>
				</dd>
			</dl>
			<dl>
				<dt>数量：</dt>
				<dd>
					<input name="order.num" type="text" size="20" alt="请输入商品数量"
						class="required digits" value="${order.num }"/>
				</dd>
			</dl>
			<dl>
				<dt>总价：</dt>
				<dd>
					<input name="order.totalprice" type="text" size="20" alt="请输入商品总价"
						class="required" value="${order.totalprice }"/>
				</dd>
			</dl>
			<dl>
				<dt>订单状态</dt>
			...
			<dl>
				...
				<dd>
					<input name="order.address" type="text" size="20" alt="请输入收货地址ID"
						class="required" value="${order.address }"/>
				</dd>
			</dl>
